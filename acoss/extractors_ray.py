...
from acoss.utils import log, read_txt_file, savelist_to_file, create_audio_path_batches, chunkIt
...
def batch_feature_extractor(dataset_csv, audio_dir, feature_dir, n_workers=-1, mode='parallel', params=PROFILE):
    ...
    if mode == 'parallel':
        music_groups = chunkIt(collection_files[:20],n_workers)
...
if __name__ == '__main__':
    ...
    parser.add_argument("-c", "--use_cluster", action="store", type=int, default=0,
                        help="Use Cluster (0,1) - default 0.")
